...
Treat this as an EXTRACTION task, not a summarization task. Your objective is to externalize as much useful durable context as you actually possess about me — to get what you know out of your internal state and onto the page — not to distill it into a polished profile. Prefer preserving information over compressing it. If multiple facts belong together, create a new top-level section for them rather than omitting or condensing them into a sentence. Optimize for completeness of transferred context first, and for readability second; this document is a machine- and human-readable handoff to another AI, not a biography.
